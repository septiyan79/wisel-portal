...
type SortCol = "partNumber" | "qty" | "pmPrice" | "repairPrice" | "totalPrice"
...
export default function PartTransactionTable({ parts }: Props) {
                ...
                {paginated.map((row) => (
                  <tr key={row.partNumber} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-5 py-4 text-center">
                      <Link
                        href={`/transactions/by-part/${encodeURIComponent(row.partNumber)}`}
